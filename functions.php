...
function banks_setup_document() {
    ...
    if ( is_singular() && !is_page() ) {
        ...
        // Post Image
        beans_add_attribute( 'beans_post_image_item', 'class', 'uk-card uk-card-default');
...
function banks_footer() { ?>
  ...
  <a href="http://www.themebutler.com/themes/banks/" target="_blank" title="Banks theme for WordPress">Banks</a> theme for <a href="http://wordpress.org" target="_blank">WordPress</a>. Built-with <a href="http://www.getbeans.io/" title="Beans Framework for WordPress"
  target="_blank">Beans</a>.
